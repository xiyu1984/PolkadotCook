...
#[ink::contract]
mod kittyerc20 {
    use ink::storage::Mapping as Mapping;
    ...
    impl Kittyerc20 {
        ...
        pub fn new(total_supply: Balance) -> Self {
            ...
            Self {
                name: ink::prelude::string::String::from("Kittyerc20"),
                total_supply,
                balances,
    ...
    mod tests {
        ...
        type Event = <super::Kittyerc20 as ::ink::reflect::ContractEventBase>::Type;
        ...
        fn assert_transfer_event(
            ...
            let expected_topics = vec![
                encoded_into_hash(&PrefixedValue {
                    value: b"Kittyerc20::Transfer",
                    prefix: b"",
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"Kittyerc20::Transfer::from",
                    value: &expected_from,
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"Kittyerc20::Transfer::to",
                    value: &expected_to,
                }),
                encoded_into_hash(&PrefixedValue {
                    prefix: b"Kittyerc20::Transfer::value",
        ...
        fn new_works() {
            // Constructor works.
            let _erc20 = super::Kittyerc20::new(100);

            assert_eq!(b"Kittyerc20", _erc20.name.as_bytes());
        ...
        fn total_supply_works() {
            // Constructor works.
            let erc20 = super::Kittyerc20::new(100);
            // Transfer event triggered during initial construction.
            let emitted_events = ink::env::test::recorded_events().collect::<Vec<_>>();
            assert_transfer_event(
                &emitted_events[0],
        ...
        fn transfer_works() {
            // Constructor works.
            let mut erc20 = super::Kittyerc20::new(100);
            // Transfer event triggered during initial construction.
            let accounts =
                ink::env::test::default_accounts::<ink::env::DefaultEnvironment>();
